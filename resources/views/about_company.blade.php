  ...
  <body>
      ...
      <div class="container">
        <div class="nav_contact">
          <div class="shopping_bag">
            <img src="/Home/home_img/Shopping bag.png" alt="shopping_bag" />
            <div>
              <h5>Корзина (5):</h5>
              <h4>34 000 ₽</h4>
            </div>
      ...
      <nav>
        <div class="container">
          <ul>
            ...
            <li>
              <a href="">Часы <i class="fas fa-thin fa-chevron-down"></i></a>
            </li>
            ...
            <li>
              <a href=""
                >Для покупателей <i class="fas fa-thin fa-chevron-down"></i
              ></a>
            </li>
          </ul>
        </div>
        ...
        <div class="container">
          <div class="row">
            <div class="header_title">
              <h1><a href="/Home/home.html">Главная</a>/О компании</h1>

              <div class="gift">
                <h1>О компании</h1>
                <p>
                  Компания «НЕВА-ТАЙМ» была создана в 2011 году. В 2012 году мы
                  стали фирменным магазином: Emporio Armani, Calvin
                  Klein, Michael Kors, Diesel
                </p>
                <p>
                  Мы продаем только оригинальную продукцию, имеющую
                  соответствующие сертификаты.
                </p>
                <p>Общество с ограниченной ответственностью «Дар».</p>
                <p>ИНН: 7813281456</p>
                <p>ОГРН: 1177847213323</p>
                <p>
                  Юридический адрес: 197110, Санкт-Петербург, Ждановская улица,
                  д. 21 литер «Г», помещение 1-н офис 6
                </p>
              </div>
            </div>
    ...
    <main>
      <div class="information">
        ...
        <div class="dad_div">
          <div>
            <i class="fas fa-light fa-phone-volume"></i>
            <h4>
              <span> 8 (800) 350 57 81 </span> - бесплатный звонок по России
            </h4>
          </div>
          <div>
            <i class="fas fa-light fa-phone-volume"></i>
      ...
      <div class="brand_section">
        <h1>Наши бренды</h1>
        <div class="brands">
            <div class="brand"><img src="./img/image 5.png" alt=""></div>
            <div class="brand"><img src="./img/image 5.png" alt=""></div>
            <div class="brand"><img src="./img/image 5.png" alt=""></div>
        </div>
        ...
        <div class="contact">
          <div>
            ...
            <div class="social-account">
              <img src="/Home/home_img/004-youtube.png" alt="004-youtube" />
              <img src="/Home/home_img/015-vkontakte.png" alt="015-wkontakte" />
            </div>
          </div>
        </div>
      </div>
