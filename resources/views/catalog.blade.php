...
<html lang="en">
  ...
  <body>
    ...
    <main>
      <div class="container">
        <h3>Главная/Женские часы Michael Kors Оригинал</h3>
        ...
        <section class="watches">
          ...
          <div class="items">
            <div>
              <div class="group-1">
                <div class="watch_1">
                  <img src="./catalog_img/image 1.png" alt="rolex-1" />
                  <h2>Часы Michael Kors MK3178</h2>
                  <h3><del>25 000 ₽</del> 11 900₽</h3>
                  <button>В КОРЗИНУ</button>
                </div>
                <div class="watch_2">
                  <img src="./catalog_img/image 1(1).png" alt="rolex-1" />
                  <h2>Часы Michael Kors MK3178</h2>
                  <h3><del>25 000 ₽</del> 11 900₽</h3>
                  <button>В КОРЗИНУ</button>
                </div>
                <div class="watch_3">
                  <img src="./catalog_img/image 1(2).png" alt="rolex-1" />
                  <h2>Часы Michael Kors MK3178</h2>
                  <h3><del>25 000 ₽</del> 11 900₽</h3>
                  <button>В КОРЗИНУ</button>
                </div>
                <div class="watch_4">
                  <img src="./catalog_img/image 1(3).png" alt="rolex-1" />
                  <h2>Часы Michael Kors MK3178</h2>
                  <h3><del>25 000 ₽</del> 11 900₽</h3>
                  <button>В КОРЗИНУ</button>
                </div>
          ...
          <div class="btn">
            <button class="btn-veiw-more">ПОКАЗАТЬ ЕЩЕ</button>
          </div>
        </section>
      </div>
    </main>
